        ...
        */
        ...
        public void Update()
        {
            ...
            if (Player != null)
            {
                ...
                Profiler.ExitContext("MobilesUpdate");
                ...
                Profiler.ExitContext("ItemsUpdate");
                ...
                Profiler.EnterContext("EffectManager");
                _effectManager.Update();
                Profiler.ExitContext("EffectManager");

                Profiler.EnterContext("WorldText");
                WorldTextManager.Update();
                Profiler.ExitContext("WorldText");

...
namespace ClassicUO.Game.UI.Gumps
{
    public class Gump : Control
    {
        ...
        public void CenterXInScreen()
        {
            ...
            X = (int)((windowBounds.Width / scale - Width) / 2);
        }
        ...
        public void CenterYInScreen()
        {
            Rectangle windowBounds = Client.Game.Window.ClientBounds;
            float scale = Client.Game.RenderScale;
            Y = (int)((windowBounds.Height / scale - Height) / 2);
        }
        ...
        public void SetInScreen()
        {
            ...
            int visibleWidth = (int)(windowBounds.Width / scale);
            int visibleHeight = (int)(windowBounds.Height / scale);

            int halfWidth = Width / 2;
            int halfHeight = Height / 2;

            int newX = (int)MathHelper.Clamp(X, -halfWidth, visibleWidth - halfWidth);
            int newY = (int)MathHelper.Clamp(Y, -halfHeight, visibleHeight - halfHeight);
